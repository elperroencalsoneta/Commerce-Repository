...
import { getOffers } from '../../redux/actions/products';
...
const Shop = ({
    ...
    useEffect(() => {
        ...
        dispatch(getOffers());
        window.scrollTo(0,0)
    }, [get_categories, get_products, dispatch])
    ...
    const showProducts = () => {
      let results = []
      const display = products.filter(product => product.in_offer === true).map((product, index) => {
        return (
            <div key={index}>
...
{/* CORREGIR DESDE AQUI HACIA ABAJO */}
                    ...
                    {({open}) => (
                      ...
                      <Disclosure.Button className="px-2 py-3 bg-white w-full flex items-center justify-between text-gray-400 hover:text-gray-500">
                        ...
                        <span className="ml-6 flex items-center">
                          {open ? (
                            // MINUS ICON
                            // MORE INFORMATION VISIT HEADLESS UI
...
{/* CORREGIR HACIA ABAJO Y NO TOCAR NADA */}
